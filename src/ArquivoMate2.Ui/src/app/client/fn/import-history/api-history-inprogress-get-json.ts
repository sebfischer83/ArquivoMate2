...
export function apiHistoryInprogressGet$Json(http: HttpClient, rootUrl: string, params?: ApiHistoryInprogressGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<ImportHistoryListDtoApiResponse>> {

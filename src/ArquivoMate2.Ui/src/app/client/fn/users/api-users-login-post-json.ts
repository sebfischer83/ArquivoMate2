...
export function apiUsersLoginPost$Json(http: HttpClient, rootUrl: string, params: ApiUsersLoginPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDto>> {
